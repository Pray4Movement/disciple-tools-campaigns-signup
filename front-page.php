<?php get_header(); ?>
    ...
    <div class="content two-col">
        ...
        <div class="" style="padding:0 2rem 0 2rem">
            ...
            <br>
            <p>
                Note: If you have already created a campaign in the past, please sign in and create a new campaign from the settings area. See <a href="https://prayer.tools/docs/ramadan-getting-started/#renewing" target="_blank">instructions</a>.
            </p>
        </div>
    </div>
